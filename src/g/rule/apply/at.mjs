...
export async function g_rule_apply_at(input, rule, index) {
...
let test_cases = [{
  ...
  input: [["d", "a", "b", "c"], rule, 1],
  output: ["d", "a", "a", "b", "c"]
}];
await m_js_for_each(test_cases, async test_case => {
  await m_js_assert(m_js_equals_json)(await g_rule_apply_at(...test_case.input), test_case.output);
});
